...
const Card = () => {
  return (
    <div className="bg-blue-100 ">
          <img src="/image/meeting.png" alt="" />
          <h1 className="text-xl font-semibold ml-5">judul berita</h1>
          <div className="text-blue-700 text-sm flex ml-3">
          ...
          {" "}
          <div className="h-1/2 mx-5  overflow-auto px-5 scrollbar scrollbar-thumb-slate-900 scrollbar-track-blue-100">
